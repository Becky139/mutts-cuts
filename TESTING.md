...
![js-jshint](docs/readme/testing/linter-checks/02-js-jshint.PNG "js-jshint")
...
5. User Story - As a logged in user I can click a button so that I can delete my account.
6. User Story - As a logged in user I can request an email so that I can reset my account password if I have forgotten it.
7. User Story - As a logged in user I can request an email so that be reminded of an appointment.  COULD HAVE item.
